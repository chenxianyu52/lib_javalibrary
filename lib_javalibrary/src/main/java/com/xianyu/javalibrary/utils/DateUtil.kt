...
object DateUtil {
    ...
    private fun getSimpleDateFormat(type: FormatType): SimpleDateFormat {
        ...
        when (type) {
            FormatType.yyyy -> sdf = SimpleDateFormat("yyyy")
            FormatType.yyyyMM -> sdf = SimpleDateFormat("yyyy-MM")
            FormatType.yyyyMMdd -> sdf = SimpleDateFormat("yyyy-MM-dd")
            FormatType.yyyyMMddHHmm -> sdf = SimpleDateFormat("yyyy-MM-dd HH:mm")
            FormatType.yyyyMMddHHmmss -> sdf = SimpleDateFormat("yyyy-MM-dd HH:mm:ss")
            FormatType.MMdd -> sdf = SimpleDateFormat("MM-dd")
            FormatType.HHmm -> sdf = SimpleDateFormat("HH:mm")
            FormatType.MM -> sdf = SimpleDateFormat("MM")
            FormatType.dd -> sdf = SimpleDateFormat("dd")
            FormatType.MMddHHmm -> sdf = SimpleDateFormat("MM-dd HH:mm")
